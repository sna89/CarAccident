...
class LangChainSQL:
    def __init__(self):
        ...
        self.db_url = db_url.format(db_pass)
    ...
    def query_llm(self,
        ...
        for event in events:
            ...
            # if event["messages"].get("role", "") == "tool":
            #     result_table = output.get("content")
            #     # Optionally, print intermediate SQL outputs
            #     print("Intermediate SQL output:", result_table)
